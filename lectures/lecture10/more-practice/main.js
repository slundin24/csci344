const statuses = [
    ...
    },
    {
        ...
        image_url:
            "http://pbs.twimg.com/ext_tw_video_thumb/1377036884514377729/pu/img/wkXDJqYZIBYs2gK4.jpg",
    },
    {
...
/**
 * HINT. To append an element inside of an existing one, do this:
 */
const sampleDOMAppend = () => {
    const targetEL = document.querySelector("#output");
    const htmlSnippet = `<div>hello world!</div>`;
    targetEL.insertAdjacentHTML("beforeend", htmlSnippet);
};
